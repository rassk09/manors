<div class="form-group row" data-attr="{{ $field->getTranslationAttribute($item) }}">
    ...
    <div class="col-md-5">
        <div class="input-group">
            <span class="form-control" data-source>{{ $field->getValue($item) }}</span>
    ...
    <div class="col-md-5">
        {!! Form::text($field->getTranslationAttribute($item), $locale->getContent($field->getTranslationAttribute($item)), ['class' => 'form-control']) !!}
    </div>
</div>