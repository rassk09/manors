<div class="form-group row" data-attr="{{ $field->getTranslationAttribute($item) }}">
    ...
    <div class="col-md-5">
        <div class="input-group">
            <span class="form-control height-300" data-source data-mce>{!! $field->getValue($item) !!}</span>
    ...
    <div class="col-md-5">
        {!! Form::textarea($field->getTranslationAttribute($item), $locale->getContent($field->getTranslationAttribute($item)), ['class' => 'form-control mce height-150']) !!}
    </div>
</div>